            ...
            Specification.find({specification_group_id: new_specification_group._id}, function (error, new_specification_list) {
                if (new_specification_list.length > 0) {
                    var create_new_specification_group_for_item = {'unique_id': specification_group_in_item.unique_id,
                        'range': specification_group_in_item.range, 'max_range': new_specification_group.max_range,
...
exports.deleteImageFromFolder = function (old_img_path, id) {
    ...
    if (old_img_path != undefined && old_img_path != null && old_img_path != "") {
...
exports.abort_payment_for_selected_payment_gateway = function (order_payment, return_data) {
    Payment_gateway.findOne({_id: order_payment.payment_id}, function (error, payment_gateway) {
        if (payment_gateway)
        {
						var request = require('request');                                                                
						request({
							...
							json: true,
							body: {
								"instructionType": "abort","amount":Math.round((order_payment.capture_amount * 100)),
							}
